...
using GeRenXing.OpenPlatform.OAuthClient;
using OpenPlatform.Tool.Commom;
using OpenPlatform.Tool.Utils;

namespace OpenPlatform.Tool.OAuthClient.TencentQQ
{
    /// <summary>
    ...
    /// QQ: 1851690435
    /// </summary>
    public class TencentQQClient:GeRenXing.OpenPlatform.OAuthClient.OAuthClient
    {
        #region //构造方法
